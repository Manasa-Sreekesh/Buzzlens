...
// Used by search.js when --sources is omitted. YouTube works with no
// credential via its public fallback; Twitter/X requires TWITTER_BEARER_TOKEN
// (no public fallback exists for it) — Phase 1's credential check surfaces
// that requirement to the user when it's missing.
const DEFAULT_SOURCES = ['youtube', 'twitter'];
