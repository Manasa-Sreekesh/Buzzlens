...
// Used by search.js when --sources is omitted — both work with no credential
// via their public fallback, so there's nothing a default run has to block on.
const DEFAULT_SOURCES = ['youtube', 'reddit'];
